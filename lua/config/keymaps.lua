...
vim.keymap.set("n", "L", ":bnext<CR>", opts("Buffer next"))
vim.keymap.set("n", "H", ":bprev<CR>", opts("Buffer prev"))
...
vim.keymap.set("n", "<Leader>fL", ":Telescope file_browser<CR>", opts("Open file browser in cwd"))
